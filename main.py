...
def start(client, message):
    kb = [[InlineKeyboardButton('موقع عربي بلس 🌐', url=chnnl),InlineKeyboardButton('قناة عربي بلس 🔰', url="https://t.me/arabii_plus"/n/n),InlineKeyboardButton('تابع المطور على انستغرام', url="https://instagram.com/s_awaftah")]]
    kb2 = [[InlineKeyboardButton('تابع المطور على انستغرام', url="https://instagram.com/s_awaftah")]]
    reply_markup = InlineKeyboardMarkup(kb,kb2)
